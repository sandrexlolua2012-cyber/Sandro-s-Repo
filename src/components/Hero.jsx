...
export default function Hero() {
  ...
  return (
    <section ref={ref} id="hero" className="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden bg-charcoal-900">
      {/* Ambient orbs */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <motion.div
          ...
          style={{ background: 'radial-gradient(circle, rgba(139,26,26,0.15) 0%, transparent 70%)', filter: 'blur(80px)' }}
        />
        <motion.div
          animate={{ x: [0, 30, -20, 0], y: [0, 20, -30, 0] }}
          transition={{ duration: 26, repeat: Infinity, ease: 'easeInOut', delay: 6 }}
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] rounded-full"
          style={{ background: 'radial-gradient(ellipse, rgba(180,140,60,0.06) 0%, transparent 70%)', filter: 'blur(40px)' }}
        />
        {/* Grain overlay */}
        ...
        {/* Vignette */}
        <div className="absolute inset-0" style={{ background: 'radial-gradient(ellipse at center, transparent 30%, rgba(8,8,8,0.8) 100%)' }} />
      </div>
      ...
      <motion.div style={{ y, opacity }} className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        ...
        <motion.p
          ...
          className="font-sans font-light text-cream-300 text-base md:text-lg leading-relaxed max-w-lg mx-auto mb-14 tracking-wide"
        >
