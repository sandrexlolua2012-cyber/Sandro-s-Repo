...
export default function Experience() {
  ...
  return (
    <section id="experience" className="py-16 md:py-24 overflow-hidden" style={{ background: '#faf8f5' }}>
        ...
        <div className="grid md:grid-cols-2 gap-x-12">
          {ex.items.map((f, i) => (
            <motion.div
              ...
              className="group relative flex flex-col gap-5 py-12 border-b border-l-2 pl-6 overflow-hidden"
            ...
            >
              ...
              <div className="relative z-10">
                <h3 className={`${sf} text-3xl md:text-4xl font-light text-charcoal-900 group-hover:text-gold-600 transition-colors duration-500`}>
                  {f.title}
                </h3>
              </div>
              <p className={`${ss} font-light text-[14px] leading-8 relative z-10`} style={{ color: '#4a3d2e' }}>{f.text}</p>
